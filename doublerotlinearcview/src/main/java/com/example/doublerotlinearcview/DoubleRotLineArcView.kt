...
class DoubleRotLineArcView(ctx : Context) : View(ctx) {
    ...
    data class DRLANode(var i : Int, val state : State = State()) {

        private var next : DRLANode? = null
        private var prev : DRLANode? = null
        ...
        fun getNext(dir : Int, cb : () -> Unit) : DRLANode {
            var curr : DRLANode? = prev
            if (dir == 1) {
                curr = next
            }
            if (curr != null) {
    ...
    data class DoubleRotLineArc(var i : Int) {

        private var curr : DRLANode = DRLANode(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : DoubleRotLineArcView {
            val view : DoubleRotLineArcView = DoubleRotLineArcView(activity)
